 ...
 */
    ...
    hasAnyRowConflicts: function() {
      ...
      for (var row = 0; row < nRows; row++) {
        hasConflict = hasConflict || this.hasRowConflictAt(row);
      }
      return hasConflict;
    },
    ...
    hasColConflictAt: function(colIndex) {
      ...
      var nRows = this.get('n');
      for (var row = 0; row < nRows; row++) {
        hasConflict = hasConflict + this.get(row)[colIndex];
      }
    ...
    hasAnyColConflicts: function() {
      ...
      for (var col = 0; col < nCols; col++) {
        hasConflict = hasConflict || this.hasColConflictAt(col);
      }
      return hasConflict;
    },
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      ...
      var startRow = 0;
      var sum = 0;
      while (!this._isInBounds(0, colIndex)) {
        startRow += 1;
        colIndex += 1;
      }
    ...
    hasAnyMajorDiagonalConflicts: function() {
      ...
      for (var row = 0; row < max; row++) {
        for (var col = 0; col < max; col++) {
          if (row === 0 || col === 0) {
            hasConflict = hasConflict || this.hasMajorDiagonalConflictAt(this._getFirstRowColumnIndexForMajorDiagonalOn(row, col));
          }
        }
      }
